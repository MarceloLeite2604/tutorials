package com.github.marceloleite2604.tutorials.spring.cloud.stream.configuration.rabbitmq;
...
public class RabbitMqConfiguration {
	...
	public SmartInitializingSingleton reconfigureConnectionFactory(
		...
		return () -> connectionFactory.setConnectionNameStrategy(
				f -> environment.getProperty("spring.application.name", "default-server-name"));
	}
