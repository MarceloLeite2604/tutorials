package org.marceloleite.tutorials.spring.batch.remote.chunking.util;
...
public final class ActiveMQUtil {
	...
	public static ActiveMQConnectionFactory criarConnectionFactory() {
	...
	public static void encerrarConexao(Connection connection) {
		if (connection != null) {
			try {
				...
				throw new RuntimeException("Erro ao encerrar a conexão com o servidor JMS.",
						excecao);
			}
		}
	}
