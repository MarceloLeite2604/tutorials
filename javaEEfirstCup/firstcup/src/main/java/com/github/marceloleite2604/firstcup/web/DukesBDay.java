 ...
 */
package com.github.marceloleite2604.firstcup.web;
...
import com.github.marceloleite2604.firstcup.ejb.DukesBirthdayBean;
...
public class DukesBDay implements Serializable {
	...
	public int getAge() {
		try {
			...
			WebTarget target = client.target("http://localhost:8080/dukes-age/rest/dukesAge");
	 ...
	 *
	 * @param averageAgeDifference
	 *            new value of averageAgeDifference
	 */
